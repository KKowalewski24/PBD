...
-- ZADANIE 1:STWORZYĆ BLOK ANONIMOWY, KTÓRY PRZY UŻYCIU KURSORA DLA
-- KAŻDEGO PRACOWNIKA Z TABELI PRACOWNICY WYPISUJE NA EKRANIE TEKST:
-- 'SZEFEM PRACOWNIKA NAZWISKO JEST NAZWISKO_SZEFA', GDZIE NAZWISKO
-- ORAZ NAZWISKO_SZEFA POCHODZĄ Z TABELI PRACOWNICY
--
-- ZADANIE 2: STWORZYĆ PROCEDURĘ, KTÓRA POBIERA NAZWISKO PRACOWNIKA
-- JAKO PARAMETR, ZWIĘKSZA PŁACĘ MINIMALNĄ DLA STANOWISKA TEGO
-- PRACOWNIKA O 10% I WYPISUJE KOMUNIKAT INFORMUJĄCY O TYM, ŻE OPERACJA SIĘ POWIODŁA.
-- JEZELI NIE ZNAJDZIE TAKIEGO PRACOWNIKA, TO WYPISUJE ODPOWIEDNI
-- KOMUNIKAT POPRZEZ OBSLUGĘ BŁĘDÓW.
...
--
--
-- ZADANIE 4: STWORZYĆ TRIGER, KTÓRY MONITORUJE WSZYSTKIE ZMIANY W
-- TABELI PRACOWNICY I ZAPISUJE STARE WARTOŚCI (WARTOŚCI ZMIENIANE
-- LUB USUWANE) Z TEJ TABELI DO INNEJ TABELI O TAKIEJ SAMEJ STRUKTURZE
-- CO TABELA PRACOWNICY.
